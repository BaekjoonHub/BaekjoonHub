...
export default class EnhancedTemplateService {
   ...
   */
  static async getDirNameWithTemplate(platform, defaultDirName, language, data, useCustomTemplate, customTemplate, orgOption) {
    try {
      // 템플릿에 사용할 데이터 준비
      ...
      // 언어별 정리 옵션 확인
      // const orgOption = await getObjectFromLocalStorage(STORAGE_KEYS.ORG_OPTION);
      // const orgOption = 'platform'; // 임시
