 ...
 */
const swexpertacademyProblemInfoMapper = (problemData) => ({
 ...
 */
const uploadOneSolveProblemOnGit = PlatformHubBase.createUploadFunction(PLATFORMS.SWEXPERTACADEMY, swexpertacademyProblemInfoMapper);
