...
const RESULT_CATEGORY = {
  ...
  RESULT_ENG_PENDING: 'wait',
  RESULT_ENG_PENDING_REJUDGE: 'rejudge-wait',
  RESULT_ENG_NO_JUDGE: 'no-judge',
  RESULT_ENG_PREPARE_FOR_JUDGE: 'compile',
  RESULT_ENG_JUDGING: 'judging',
  RESULT_ENG_ACCEPTED: 'ac',
  RESULT_ENG_PARTIALLY_ACCEPTED: 'pac',
  RESULT_ENG_PRESENTATION_ERROR: 'pe',
  RESULT_ENG_WRONG_ANSWER: 'wa',
  RESULT_ENG_ACCEPTED_NOT_CORRECT: 'awa',
  RESULT_ENG_TIME_LIMIT_EXCEEDED: 'tle',
  RESULT_ENG_MEMORY_LIMIT_EXCEEDED: 'mle',
  RESULT_ENG_OUTPUT_LIMIT_EXCEEDED: 'ole',
  RESULT_ENG_RUNTIME_ERROR: 'rte',
  RESULT_ENG_COMPILATION_ERROR: 'ce',
};
